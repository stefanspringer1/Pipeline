...
@Suite(.serialized) struct SynchronousPipelineTests {
    ...
    @Test func testExecution() throws {
        ...
        func step1<MetaData: ExecutionMetaData>(during execution: Execution<MetaData>, abortInStep2a: Bool = false) {
            ...
            execution.effectuate("doing something in step1", checking: StepID(crossModuleFileDesignation: #file, functionSignature: #function)) {
                ...
                execution.optional(named: "step2", description: "we usually do not step2") {
                    ...
                    step2a(during: execution, abort: abortInStep2a)
            ...
            execution.effectuate("doing something in step2b", checking: StepID(crossModuleFileDesignation: #file, functionSignature: #function)) {
                execution.dispensable(named: "calling step3a in step2b", description: "we might want to skip step3a in step2b") {
                    #expect(execution.executionPath == """
                        step step1(during:abortInStep2a:)@\(#file) (doing something in step1) -> optional part "step2" (we usually do not step2) -> doing "calling step2b in step1" -> step step2b(during:)@\(#file) (doing something in step2b) -> dispensable part "calling step3a in step2b" (we might want to skip step3a in step2b)
                        """)
                    step3a(during: execution)
                    execution.force {
                        step3a(during: execution)
        ...
        do {
            ...
            #expect(logger.messages.joined(separator: "\n") == """
                beginning step step1(during:abortInStep2a:)@\(#file) (doing something in step1)
                    skipping optional part "step2" (we usually do not step2)
                ending step step1(during:abortInStep2a:)@\(#file) (doing something in step1)
                """)
        }
            ...
            #expect(logger.messages.joined(separator: "\n") == """
                beginning step step1(during:abortInStep2a:)@\(#file) (doing something in step1)
                    beginning optional part "step2" (we usually do not step2)
                        beginning step step2a(during:abort:)@\(#file) (doing something in step2a)
                            beginning dispensible part "calling step3a and step3b in step2a" (we might want to skip step3a and step3b in step2a)
                                ...
                                ending step step3b(during:)@\(#file) (doing something in step3b)
                            ending dispensible part "calling step3a and step3b in step2a" (we might want to skip step3a and step3b in step2a)
                        ending step step2a(during:abort:)@\(#file) (doing something in step2a)
                        beginning "calling step2b in step1"
                            beginning step step2b(during:)@\(#file) (doing something in step2b)
                                beginning dispensible part "calling step3a in step2b" (we might want to skip step3a in step2b)
                                    skipping previously executed step step3a(during:)@\(#file) (doing something in step3a)
                                    beginning forcing steps
                                        beginning forced step step3a(during:)@\(#file) (doing something in step3a)
                                            skipping previously executed step step4(during:)@\(#file) (doing something in step4)
                                        ending forced step step3a(during:)@\(#file) (doing something in step3a)
                                    ending forcing steps
                                ending dispensible part "calling step3a in step2b" (we might want to skip step3a in step2b)
                            ending step step2b(during:)@\(#file) (doing something in step2b)
        ...
        do {
            ...
            step1(during: execution, abortInStep2a: true)
                    ...
                    beginning optional part "step2" (we usually do not step2)
                        beginning step step2a(during:abort:)@\(#file) (doing something in step2a)
                            beginning dispensible part "calling step3a and step3b in step2a" (we might want to skip step3a and step3b in step2a)
                                ...
                                skipping step in aborted execution step3b(during:)@\(#file) (doing something in step3b)
                            ending dispensible part "calling step3a and step3b in step2a" (we might want to skip step3a and step3b in step2a)
                        aborted step step2a(during:abort:)@\(#file) (doing something in step2a)
                        beginning "calling step2b in step1"
                            skipping step in aborted execution step2b(during:)@\(#file) (doing something in step2b)
                        ending "calling step2b in step1"
                    ending optional part "step2" (we usually do not step2)
                aborted step step1(during:abortInStep2a:)@\(#file) (doing something in step1)
                """)
        }
